...
/**
   ...
   2% fee auto moved to devs wallet
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x47f1b90a377A5D97D4B3aBd67006Cb4F4F661d8d;
...
contract Surtr is Context, IERC20, Ownable {
    ...
    address private _Feeadrress = 0x47f1b90a377A5D97D4B3aBd67006Cb4F4F661d8d;
    ...
    string private _name = "Surtr Coin";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0x47f1b90a377A5D97D4B3aBd67006Cb4F4F661d8d, 'We can not exclude Uniswap router.');
    ...
    function _takeCharity(uint256 tCharity) private {
        uint256 currentRate =  _getRate();
        uint256 rCharity = tCharity.mul(currentRate);
        _rOwned[_Feeadrress] = _rOwned[_Feeadrress].add(rCharity);
        if(_isExcluded[_Feeadrress])
            _tOwned[_Feeadrress] = _tOwned[_Feeadrress].add(tCharity);
    }
